      ...
      >
        ...
        <div className="flex items-center gap-3 xl:gap-5">
          <button
            ...
            className="p-2 xl:p-[9px] text-white bg-white/5 rounded-full border border-white/10 hover:bg-white/10 transition-colors group"
            title="Open Terminal"
          >
          ...
          <button
            ...
            className="p-2 xl:p-[9px] text-zinc-400 bg-white/5 rounded-full border border-white/10 hover:bg-white/10 transition-colors group"
      ...
      <div className="md:hidden fixed top-6 right-6 z-50 flex flex-col items-end gap-2">
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              <div className="flex flex-col gap-2 p-2 bg-background/90 border border-white/10 rounded-lg backdrop-blur-md mb-2">
                {NAV_LINKS.map((link) => (
                  <a
                    key={link.name}
                    href={link.href}
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-background/90 border border-white/10 text-white rounded-lg shadow-none hover:bg-white/5 transition-colors backdrop-blur-md font-mono text-sm"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-background/90 border border-white/10 text-zinc-400 rounded-lg shadow-none hover:bg-white/5 transition-colors backdrop-blur-md font-mono text-sm uppercase font-bold"
              >
