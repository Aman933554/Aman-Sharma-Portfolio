          ...
          <div className="max-w-5xl mx-auto px-6 py-12 relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-8">
                <section>
                  <h3 className="text-xl font-bold border-b border-white/10 pb-2 mb-4 flex items-center gap-2">
                    <FileText className="text-white" size={20} /> Summary
                  </h3>
                  <div className="space-y-2">
                    <p className="text-2xl font-bold text-white">{portfolioData.personal.name}</p>
                    <p className="text-zinc-400 font-mono text-sm">{portfolioData.personal.title}</p>
                ...
                <section>
                  <h3 className="text-xl font-bold border-b border-white/10 pb-2 mb-4 flex items-center gap-2">
                    <Code className="text-white" size={20} /> Top Skills
                  </h3>
                ...
                <section>
                  <h3 className="text-xl font-bold border-b border-white/10 pb-2 mb-4 flex items-center gap-2">
                    <GraduationCap className="text-white" size={20} /> Education
                  </h3>
              ...
              <div className="lg:col-span-2 space-y-8">
                <section>
                  <h3 className="text-xl font-bold border-b border-white/10 pb-2 mb-4 flex items-center gap-2">
                    <Briefcase className="text-zinc-400" size={20} /> Experience
                  </h3>
                  <div className="space-y-6">
                    {portfolioData.experience.map((exp, idx) => (
                      <div key={idx} className="relative pl-6 border-l border-white/10">
                        <div className="absolute w-3 h-3 bg-zinc-400 rounded-full -left-[6.5px] top-1.5" />
                        ...
                        <p className="text-white text-sm mb-2">{exp.organization}</p>
                ...
                <section>
                  <h3 className="text-xl font-bold border-b border-white/10 pb-2 mb-4 flex items-center gap-2">
                    <Code className="text-zinc-400" size={20} /> Key Projects
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {portfolioData.projects.map((project, idx) => (
                      <div key={idx} className="bg-white/5 border border-white/10 p-5 rounded-lg hover:border-white/20 transition-colors">
                        ...
                        <p className="text-xs font-mono text-white mb-3">{project.subtitle}</p>
