    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-[800px] xl:max-w-[1100px] h-[600px] xl:h-[800px] max-h-[85vh] bg-background border border-white/10 rounded-xl overflow-hidden shadow-2xl flex flex-col"
        >
          {/* Header Toolbar */}
